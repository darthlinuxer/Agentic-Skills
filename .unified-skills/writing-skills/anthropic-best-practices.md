...
The [context window](https://platform.claude.com/docs) is a public good. Your Skill shares the context window with everything else LLM needs to know, including:
