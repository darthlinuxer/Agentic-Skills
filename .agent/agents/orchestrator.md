...
- **Backend & data → `backend-specialist`, `database-architect`**: [backend-development](../skills/backend-development/SKILL.md), [database-design](../skills/database-design/SKILL.md), [nodejs-best-practices](../skills/nodejs-best-practices/SKILL.md), [python-patterns](../skills/python-patterns/SKILL.md), [mcp-builder](../skills/mcp-builder/SKILL.md), [rust-pro](../skills/rust-pro/SKILL.md).
