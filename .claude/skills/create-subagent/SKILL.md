...
This repo uses platform-specific agents directories. Use this platform's project agents directory so agents are discovered correctly.

```bash
# For project-level (this platform)
mkdir -p .claude/agents
touch .claude/agents/my-agent.md

# For user-level (platform-specific user directory)
mkdir -p ~/.claude/agents
touch ~/.claude/agents/my-agent.md
```
